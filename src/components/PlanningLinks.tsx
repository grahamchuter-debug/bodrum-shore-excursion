...
const LINKS = [
  ...
  { href: "/one-day-in-bodrum-from-a-cruise-ship", label: "One Day in Bodrum" },
  { href: "/faq", label: "FAQ" },
];

export function PlanningLinks({ heading = "Keep planning your Bodrum cruise" }: { heading?: string }) {
  return (
