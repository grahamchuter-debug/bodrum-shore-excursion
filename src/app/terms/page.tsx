...
export const metadata = buildMetadata({
  title: "Terms of Use",
  description: "Terms of use for Bodrum Shore Excursions — the basis on which we provide our Bodrum cruise planning guides and information.",
  path,
});
...
export default function TermsPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Terms of Use", description: "Terms of use for Bodrum Shore Excursions.", path })]} />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="prose-body">
            ...
            <p>{SITE.name} provides planning information and guidance for cruise passengers calling at Bodrum and the Turkish Riviera. It is offered in good faith for general guidance and does not constitute professional travel advice.</p>
            ...
            <p>We link to independent providers of tours and tickets. We are not responsible for their services, availability or policies. Any booking is a contract between you and that provider.</p>
